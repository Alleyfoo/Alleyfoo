...
| Product data cleaning with sml or llm | <a href="Toolbox/notebooks/colab_walkthrough_viz.ipynb">View</a> · [Docs](docs/colab_walkthrough.md) | Product data cleaning demo using style guides and sml or llm |
...
| Tuotedatan puhdistusdemo käyttämällä kielimalleja ja tyyliopasta | <a href="Toolbox/notebooks/colab_walkthrough_viz.ipynb">View</a> · [Docs](docs/colab_walkthrough.md) | Tuotedatan puhdistusta käyttämällä kielimalleja |
